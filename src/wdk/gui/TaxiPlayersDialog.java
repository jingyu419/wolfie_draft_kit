 ...
 * @author jingyu
 */
public class TaxiPlayersDialog  extends Stage {
...
//    Boolean imageNotExisted;
    ...
    public static final String PLAYER_HEADING = "Taxi Player Details";    
     ...
     * @param messageDialog
     */
    public TaxiPlayersDialog(Stage primaryStage, Draft initDraft,  MessageDialog messageDialog) {       
    ...
    //    imageNotExisted=true;
     //get all created teams
      ...
      //   contractComboBox.setValue("S2");
        ...
        salaryNumberLabel = new Label("1");
        salaryNumberLabel.getStyleClass().add(CLASS_PROMPT_LABEL);
        ...
        EventHandler completeCancelHandler = (EventHandler<ActionEvent>) (ActionEvent ae) -> {
            ...
            TaxiPlayersDialog.this.selection = sourceButton.getText();
            TaxiPlayersDialog.this.hide();
        };
        ...
        gridPane.add(salaryNumberLabel,1,5,1,1);
    ...
    public void showEditPlayerDialog(Player itemToEdit) {
       ...
       // fantasyTeamComboBox.getSelectionModel().clearSelection();
        ...
        contractComboBox.getItems().clear();
         contractComboBox.getItems().addAll("X"); 
